...
public class StaffCRUD {
	...
	public static Integer insertStaff(String name, String profTitle, String dob, String gender, String pno, String address, String dept, Double sal){
		return null;
	}
	
	//Returns true if the update was successful else false
	//Updates the record with this new information using the ID.
	public static Boolean updateStaff(Integer id, String name, String profTitle, String dob, String gender, String pno, String address, String dept, Double sal){
		return null;
	}
